...
const Computers = ({isMobile}) => {
  ...
  return (
   <mesh>
    ...
    <primitive object={computer.scene} scale={isMobile?0.7:0.75} position={isMobile ?[0,-3,-2.2]:[0,-3.25,-1.5]} rotation={[-0.01,-0.2,-0.1]}></primitive>
   </mesh>
  )
}
...
const handlemquery=(event)=>{
  setIsMobile(event.matches);
}
mquery.addEventListener('change',handlemquery);
return ()=>{
  mquery.removeEventListener('change',handlemquery);
}
  },[])
  return (
